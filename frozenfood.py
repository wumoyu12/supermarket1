...
def ShowMenu():
    ...
    print("Welcome to the Frozen Food Department, " + currentuser[0] + "!")
    
    product_file = open("Frozenfood.txt", "r+")
    price_file = open("priceFrozenfood.txt", "r+")
    ...
    selected_number = str(input("Pick frozen food by typing the number: "))
