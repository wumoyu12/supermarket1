...
def ShowMenu():
    ...
    print("Welcome to the Fruit Department, " + currentuser[0] + "!")
    
    product_file = open("Fruit.txt", "r+")
    price_file = open("priceFruit.txt", "r+")
    ...
    selected_number = str(input("Pick a fruit by typing the number: "))
