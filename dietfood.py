...
def ShowMenu():
    ...
    print("Welcome to the Diet Food Department, " + currentuser[0] + "!")
    
    product_file = open("Dietfood.txt", "r+")
    price_file = open("priceDietfood.txt", "r+")
    ...
    selected_number = str(input("Pick diet food by typing the number: "))
