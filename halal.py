...
def ShowMenu():
    ...
    print("Welcome to the Halal Department, " + currentuser[0] + "!")
    
    product_file = open("Halal.txt", "r+")
    price_file = open("priceHalal.txt", "r+")
    ...
    selected_number = str(input("Pick halal item by typing the number: "))
