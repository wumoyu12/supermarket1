...
def ShowMenu():
    ...
    print("Welcome to the Poultry Department, " + currentuser[0] + "!")
    
    product_file = open("Poultry.txt", "r+")
    price_file = open("pricePoultry.txt", "r+")
    ...
    selected_number = str(input("Pick poultry by typing the number: "))
