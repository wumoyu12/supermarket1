...
def ShowMenu():
    ...
    print("Welcome to the Kosher Department, " + currentuser[0] + "!")
    
    product_file = open("Kosher.txt", "r+")
    price_file = open("priceKosher.txt", "r+")
    ...
    selected_number = str(input("Pick kosher item by typing the number: "))
