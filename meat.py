...
def ShowMenu():
    ...
    print("Welcome to the Meat Department, " + currentuser[0] + "!")
    
    product_file = open("Meat.txt", "r+")
    price_file = open("priceMeat.txt", "r+")
    ...
    selected_number = str(input("Pick meat by typing the number: "))
